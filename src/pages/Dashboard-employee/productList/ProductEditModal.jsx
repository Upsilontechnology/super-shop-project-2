            ...
            <div className="w-[50%] rounded-xl bg-white px-4 py-3 scale-1 opacity-1 duration-200">
                <div className="rounded-lg w-full">
                    ...
                    <div className="w-[90%] mx-auto pt-5 pb-10">
                        <h1 className="text-2xl font-semibold py-5">Edit Product Details</h1>
                        {/* mapping the data */}
                        {
                            products?.map((product) => <form key={product?._id} onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="grid lg:grid-cols-2 grid-cols-1 gap-2 md:gap-4 mb-2">
                                    ...
                                    <div className="form-control w-full my-1">
                                        ...
                                        />
                                        {errors.sellprice && (
                                            <span className="text-red-500">Sell Price is required</span>
                                        )}
                                    </div>
                                    {/* Supplier Name */}
                                    <div className="form-control w-full my-1">
