        ...
        <table className="table">
          ...
          <tbody className="">
            ...
            <tr className=" border-b-[1.2px] border-black text-center ">
              ...
              <td>Purple</td>
              <th >
                <button className="btn btn-ghost btn-xs"><FiEdit /></button>
                <button className="btn btn-ghost btn-xs"><RiDeleteBin6Line /></button>
                <button className="btn btn-ghost btn-xs"><CiCirclePlus /></button>
              </th>
            </tr>
          </tbody>
        </table>
