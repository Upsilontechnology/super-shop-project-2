                        ...
                        <form onSubmit={handleLogin} className="">
                            <div className="form-control mb-4 flex justify-center">
                                ...
                                <input
                                    type="email"
                                    name="email"
                                    placeholder="Email" className="w-full bg-[#ebedfe] border-1.5 border-[#6f98b9] placeholder-[#444444] py-4 rounded-lg border outline-none pl-8 pr-2"
                                    required />
                            </div>
                            <div className="form-control  relative flex justify-center">
                                ...
                                <input
                                    ...
                                    className="w-full border-1.5 border-[#6f98b9] bg-[#ebedfe] placeholder-[#444444] py-4 rounded-lg border outline-none pl-8 pr-2 " required />
                                <span className='absolute right-0 cursor-pointer mr-5 mt-5' onClick={() => setShowPassword(!showPassword)}>
                                    {
                            ...
                            <div className="form-control mt-8">
                                <button className="text-xl rounded-md font-semibold  py-4 bg-[#565fa8] text-white hover:bg-[#565fa8] w-full">Log In</button>
                            </div>

                            <div className='mt-16 text-center '>
                                <p>Do not have an account? <Link className='font-bold text-[#6486FD]' to='/register'>Register Now</Link></p>
                            </div>
                        </form>
                    </div>
                </div>
